                ...
                <tbody>
                  {files.map((file, index) => (
                    <tr
                      ...
                      onClick={() => {
                        window.open(
                          `https://firebasestorage.googleapis.com/v0/b/nextjs-portfolio-website.appspot.com/o/utkarsh-resume.pdf?alt=media&token=9dea3898-47b0-42b3-80f1-b20a272111c3`,
                          "_blank",
